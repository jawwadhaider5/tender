<div class=" modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header p-1 m-1">
            <h4 class="modal-title">Comments on <strong>({{$client->company_name}})</strong></h4>
        ...
        <div class="modal-body p-2">
            ...
            {!! Form::open(['url' => action('ClientController@post_client_comments'),'method' => 'POST', 'id' => 'comment_client_form']) !!}
            ...
            <div class="row">
                <div class="form-group row mb-1">
                    ...
                    <div class="col-sm-2">
                        <button type="submit" value="Post Comment" class="btn btn-primary  me-2 float-end" id="submit_client_form">Post Comment</button>
                    </div>
                </div> 
            </div>
            {!! Form::close() !!}
