<div class=" modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header p-1 m-1">
            <h4 class="modal-title">Responds on <strong>({{$future_client->client->company_name}})</strong></h4>
        ...
        <div class="modal-body p-2">
            ...
            {!! Form::open(['url' => action('FutureClientController@post_future_client_responds'),'method' => 'POST', 'id' => 'respond_future_client_form']) !!}
            ...
            <div class="row">
                <div class="form-group row mb-1">
                    ...
                    <div class="col-sm-2 p-1 pt-4"> 
                        <button type="submit" value="Post Responds" class="btn btn-primary  me-2 float-end" id="respond_future_client_formbtn">Post Responds</button>
                    </div>
                </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseThree-{{$loop->index}}" class="accordion-collapse collapse" aria-labelledby="headingThree-{{$loop->index}}" data-bs-parent="#accordionExample">
                                ...
                                <p><strong class="text-success">Assigned To</strong><small> - {{$res->assigned_to->name}} </small></p> 
                                   <p>{{$res->text}} <br> <small><a href="/future-client-respond-delete/{{$res->id}}" class="btn btn-sm btn-danger delete-respond">Delete</a></small></p>
