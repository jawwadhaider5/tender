<div class=" modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header p-1 m-1">
            <h4 class="modal-title">Files in <strong>({{$future_client->client->company_name}})</strong></h4>
        ...
        <div class="modal-body p-2">
            ...
            {!! Form::open(['url' => action('FutureClientController@post_future_client_files'), 'method' => 'POST',
                'enctype' => 'multipart/form-data', 'id' => 'file_future_client_form']) !!}
            ...
            <div class="row">
                <div class="form-group row mb-1"> 
                    ...
                    <div class="col-sm-2 p-1">
                        <button type="submit" value="Post File" class="btn btn-primary  me-2 float-end" id="file_future_client_formbtn">Upload File</button>
                    </div>
                </div>
