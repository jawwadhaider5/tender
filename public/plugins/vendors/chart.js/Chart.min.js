...
!(function(t, e) {
    ...
    function i(t) {
        var e = (function() {
                for (
                    var t = {}, e = Object.keys(n), i = e.length, a = 0; a < i; a++
                )
    ...
    var Tt = it.extend({
            ...
            update: function(t) {
                var e,
                    ...
                    i = this.getMeta().data;
                for (
                    this._ruler = this.getRuler(), e = 0, n = i.length; e < n;
                    ++e
                )
            ...
            calculateBarValuePixels: function(t, e, n) {
                ...
                return (
                    ...
                    Math.abs(l) < m &&
                    ((l = m),
                        (s = (y >= 0 && !c) || (y < 0 && c) ? o - m : o + m)), { size: l, base: o, head: s, center: s + l / 2 }
                );
            },
    ...
    H.extend(tn.prototype, {
            ...
            handleEvent: function(t) {
                ...
                return (
                    ...
                    H.callback(
                        i.onHover || i.hover.onHover, [t.native, n.active],
                        n
                    ),
        ...
        update: function(t, e, n) {
            ...
            if (
                (l.beforeUpdate(),
                    (l.maxWidth = t),
                    (l.maxHeight = e),
                    (l.margins = H.extend({ left: 0, right: 0, top: 0, bottom: 0 },
                        n
                    )),
                    (l._ticks = null),
                    (l.ticks = null),
        ...
        _autoSkip: function(t) {
            ...
            if (
                ((i = (function(t, e, n, i) {
                        ...
                        for (
                            o = 0, s = (a = H.math._factorize(l)).length - 1; o < s; o++
                        )
                            if ((r = a[o]) > u) return r;
                        return Math.max(u, 1);
                    })(l, t, 0, s)),
    ...
    var Xn = Cn.extend({
            ...
            setReductions: function(t, e, n) {
                var i = this,
                    ...
                    o = -e.t / Math.cos(n.t),
                    s = -Math.max(e.b - (i.height - i.paddingTop), 0) /
                    Math.cos(n.b);
                (a = Gn(a)),
                (r = Gn(r)),
                (o = Gn(o)),
                    ...
                    (r.pointLabels.display &&
                        (function(t) {
                            ...
                            e.save(),
                                ...
                                (e.textBaseline = "middle");
                            for (
                                var s = t.chart.data.labels.length - 1; s >= 0; s--
                            ) {
                                var l = 0 === s ? a / 2 : 0,
            ...
            buildTicks: function() {
                ...
                return (
                    ...
                    (i._unit =
                        ...
                        (s.autoSkip ?
                            ...
                            (function(t, e, n, i, a) {
                                var r, o;
                                for (
                                    r = ni.length - 1; r >= ni.indexOf(n); r--
                                )
                                    if (
                                        ((o = ni[r]),
                                            ei[o].common &&
                    ...
                    (i._majorUnit =
                        ...
                        (function(t) {
                            for (
                                var e = ni.indexOf(t) + 1, n = ni.length; e < n;
                                ++e
                            )
                        ...
                        return (
                            ...
                            ((r = oi(t, "time", e[0], "pos")),
                                ...
                                (l =
                                    ...
                                    2)), { start: s, end: l, factor: 1 / (s + 1 + l) }
                        );
                    })(i._table, d, 0, 0, o)),
                    s.reverse && d.reverse(),
                    di(i, d, i._majorUnit)
